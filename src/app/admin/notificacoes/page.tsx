            ...
            <Table>
              <TableHeader className="bg-muted/30">
                <TableRow>
                  ...
                  <TableHead className="font-black uppercase text-[10px] tracking-widest">Remetente</TableHead>
                    ...
                    <TableCell className="text-right">
                      <Dialog>
                        <DialogTrigger asChild>
                          <Button variant="ghost" size="sm" className="h-8 gap-2 font-bold text-[10px] uppercase rounded-lg">
