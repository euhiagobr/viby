...
export default function FinanceiroPage() {
  ...
  const handleStartOnboarding = async () => {
    ...
    console.log('[Client-Debug] Triggering handleStartOnboarding...');
    setIsProcessing(true);
    
    try {
      const accountRes = await createStripeConnectAccount(currentOrg.id);
      console.log('[Client-Debug] Server Action Response:', accountRes);
      ...
      if (!accountRes.url) {
        throw new Error('Onboarding URL was not generated by the server.');
      }

      console.log('[Client-Debug] Redirecting to Stripe:', accountRes.url);
      window.location.href = accountRes.url;
    } catch (e: any) {
      console.error('[Client-Debug] Onboarding Error:', e.message);
      toast({ 
        variant: "destructive", 
        title: "Erro na conexão", 
        description: e.message || "Não foi possível iniciar a conexão com o Stripe." 
      });
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <p className="text-muted-foreground font-medium">Gestão de repasses para <strong>{currentOrg.name}</strong>.</p>
          </div>
        </div>
            ...
            <CardHeader className="bg-muted/30 p-8">
              <div className="flex justify-between items-start">
                <div className="space-y-1">
                   ...
                   <CardDescription className="font-medium">Gestão automatizada via Stripe Express.</CardDescription>
                </div>
               ...
               {!currentOrg.stripeAccountId ? (
                 <div className="py-12 text-center space-y-6">
                    ...
                    <div className="space-y-2">
                       ...
                       <p className="text-sm text-muted-foreground max-w-sm mx-auto leading-relaxed">Conecte sua organização ao Stripe Express para permitir vendas internacionais e receber repasses automáticos.</p>
                    </div>
                 ...
                 <div className="space-y-8">
                    ...
                    {!isVerified && (
                      <div className="p-6 bg-blue-50 rounded-3xl border-2 border-dashed border-blue-200 flex items-start gap-4">
                         ...
                         <div className="space-y-1">
                            <h4 className="font-black uppercase text-xs italic text-blue-800">Cadastro em Análise</h4>
                            <p className="text-[10px] text-blue-700 font-medium leading-relaxed uppercase">Clique em "Atualizar Dados" para verificar se há documentos pendentes no dashboard do Stripe Express.</p>
                         </div>
                      </div>
                    )}
                 </div>
