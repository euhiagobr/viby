           ...
           <Card className="border-none shadow-sm rounded-[2rem] bg-white">
              <CardContent className="p-8 space-y-8">
                 ...
                 <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                    ...
                    <div className="space-y-2">
                       <h3 className="text-[10px] font-black uppercase opacity-60">Classificação</h3>
                   ...
                   <div className="space-y-6 pt-6 border-t border-dashed border-secondary/20 animate-in zoom-in-95">
                      <div className="flex items-center gap-3">
                         ...
                         <div>
                            ...
                            <p className="text-[10px] font-bold text-muted-foreground uppercase">Selecione os confrontos oficiais da Copa</p>
                         </div>
                      </div>
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-12 gap-4 items-end">
                         <div className="md:col-span-5 space-y-2">
                            ...
                            <Select value={matchSelection.teamA} onValueChange={v => setMatchSelection({...matchSelection, teamA: v})}>
                               <SelectTrigger className="h-12 rounded-xl"><SelectValue placeholder="Time da Casa" /></SelectTrigger>
                         ...
                         <div className="md:col-span-5 space-y-2">
                            ...
                            <Select value={matchSelection.teamB} onValueChange={v => setMatchSelection({...matchSelection, teamB: v})}>
                               <SelectTrigger className="h-12 rounded-xl"><SelectValue placeholder="Visitante" /></SelectTrigger>
                               <SelectContent className="max-h-[300px]">
                                  {availableTeams.map(t => <SelectItem key={t.id} value={t.id.toString()}>{t.name.toUpperCase()}</SelectItem>)}
                               </SelectContent>
                            </Select>
                                 ...
                                 <div key={i} className="p-4 bg-muted/20 rounded-2xl border flex items-center justify-between group">
                                    <div className="flex items-center gap-3">
                                       <div className="flex items-center -space-x-2">
                                          <img src={m.teamAFlag} className="w-6 h-6 rounded-full border border-white shadow-sm" />
                                          <img src={m.teamBFlag} className="w-6 h-6 rounded-full border border-white shadow-sm" />
                                       </div>
                                       <div>
