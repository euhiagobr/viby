    ...
    >
      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '60px', position: 'relative', zIndex: 10 }}>
        ...
        {totalSlides && totalSlides > 1 && (
          <div style={{ background: 'rgba(255,255,255,0.1)', padding: '8px 20px', borderRadius: '50px', fontSize: '16px', fontWeight: 900 }}>
      ...
      {/* Image & Main Info */}
      <div style={{ display: 'flex', gap: '40px', flex: 1, alignItems: 'center', position: 'relative', zIndex: 10 }}>
        <div style={{ width: '450px', height: '450px', borderRadius: '40px', overflow: 'hidden', boxShadow: '0 30px 60px rgba(0,0,0,0.3)', flexShrink: 0 }}>
        ...
        <div style={{ flex: 1, display: 'flex', flexDirection: 'column', gap: '20px' }}>
           ...
           <h2 style={{ fontSize: '64px', fontWeight: 900, textTransform: 'uppercase', fontStyle: 'italic', lineHeight: 0.9, margin: 0, letterSpacing: '-3px' }}>
           ...
           <div style={{ display: 'flex', alignItems: 'center', gap: '8px', opacity: 0.5 }}>
              ...
              <span style={{ fontSize: '20px', fontWeight: 800, textTransform: 'uppercase', letterSpacing: '2px' }}>{event.city}</span>
           </div>
        </div>
      </div>
      ...
      <div style={{ marginTop: 'auto', display: 'flex', justifyContent: 'space-between', alignItems: 'flex-end', position: 'relative', zIndex: 10 }}>
         <div style={{ display: 'flex', flexDirection: 'column', gap: '5px' }}>
            <p style={{ fontSize: '24px', fontWeight: 900, textTransform: 'uppercase', fontStyle: 'italic', margin: 0 }}>viby.club/{event.organizer?.username}</p>
            <p style={{ fontSize: '10px', fontWeight: 800, textTransform: 'uppercase', opacity: 0.4, letterSpacing: '4px', margin: 0 }}>Garante o seu lugar agora</p>
         </div>
         <div style={{ padding: '10px', background: '#FFFFFF', borderRadius: '20px', boxShadow: '0 10px 30px rgba(0,0,0,0.1)' }}>
