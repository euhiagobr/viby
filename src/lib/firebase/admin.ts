 ...
 * Evita erros de "Missing error payload" e falhas de OAuth2 Token 
 * ao usar credenciais explícitas e tratamento de quebra de linha na chave.
 */

const serviceAccount = {
  projectId: "vibyeventos",
  clientEmail: "firebase-adminsdk-fbsvc@vibyeventos.iam.gserviceaccount.com",
  // Garante que as quebras de linha literais do arquivo JSON sejam interpretadas corretamente pelo Node.js
